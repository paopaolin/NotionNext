...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'MENG_GUANLIN', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || '探索地球online这款游戏', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/paopaolin/NotionNext', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '20099185d@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/paopaolin/NotionNext', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://www.linkedin.com/in/guanlin-meng/', // 你的linkedIn 首页
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'IoLSstPUKg2AOAbaM81Cd',
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/outchain/player?type=2&id=1961981739.mp3',
      cover:
    ...
    },
    {
      name: '天気の子',
      artist: 'STRlighT',
      url: 'https://music.163.com/outchain/player?type=2&id=1973129951.mp3',
      cover:
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'paopaolin', // 你的用户名 e.g tangly1024
