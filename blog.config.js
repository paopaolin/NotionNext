...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'MENG_GUANLIN', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '探索地球online这款游戏', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/paopaolin', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/paopaolin', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'nope', // 你的telegram 地址 例如 https://t.me/tangly_1024
